# RailsAdmin config file. Generated on September 10, 2013 16:42
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Poliana App', 'Admin']
  ...
  # config.excluded_models = ['Bill', 'Invitation', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Bill', 'Invitation', 'User']
